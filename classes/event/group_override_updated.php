...
/**
 * The mod_privatestudentfolder group override updated event.
 *
...
/**
 * The mod_privatestudentfolder group override updated event class.
 *
...
class group_override_updated extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' updated the override with id '$this->objectid' for the privatestudentfolder with " .
